...
/**
 * Converts a digit/integer into a magazine code point.
 */
...
var encode = function (input) {
  ...
  // Handle the magazine code points.
  ...
  var basicLength = output.length; // number of magazine code points.
  var handledCPCount = basicLength; // number of code points that have been handled;

  // Finish the magazine string with a delimiter unless it's empty.
  if (basicLength) {
  ...
  while (handledCPCount < inputLength) {
    // All non-magazine code points < n have been handled already. Find the next larger one:
    var m = maxInt;
    for (i = 0; i < input.length; i++) {
      currentValue = input[i];
